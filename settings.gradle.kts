...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            plugin("micronaut-application", "io.micronaut.application").version("4.4.0")
            plugin("micronaut-aot", "io.micronaut.aot").version("4.4.0")

            library("junit", "org.junit.jupiter:junit-jupiter:5.10.3")
            library("assertj", "org.assertj:assertj-core:3.26.0")
            library("testcontainers", "org.testcontainers:testcontainers:1.19.8")
            library("testcontainers-junit5", "org.testcontainers:junit-jupiter:1.19.8")
